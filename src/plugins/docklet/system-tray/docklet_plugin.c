/* $Id: docklet_plugin.c,v 1.10 2004/01/17 00:45:00 shaster Exp $ */
...
GtkWidget *ggadu_new_item_from_stock(GtkWidget * menu, const char *str, const char *icon, GtkSignalFunc sf, gpointer data, guint accel_key,
...
GtkWidget *ggadu_new_item_from_image(GtkWidget * menu, const char *str, const char *icon, GtkSignalFunc sf, gpointer data, guint accel_key,
				     guint accel_mods, char *mod)
{
    GtkWidget *menuitem;
    GtkWidget *image;
