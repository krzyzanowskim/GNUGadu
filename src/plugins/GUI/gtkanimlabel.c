...
static gint gtk_anim_label_expose(GtkWidget * widget, GdkEventExpose * event)
{
    ...
    gdk_draw_drawable(widget->window, widget->style->bg_gc[widget->state], anim_label->pixmap, 0, 0, anim_label->pos_x, 0, widget->allocation.width,
...
static void anim_label_create_pixmap(GtkAnimLabel * anim_label)
{
    ...
    /* czyscze pixmape */
    gdk_draw_rectangle(anim_label->pixmap, widget->style->bg_gc[widget->state], TRUE, 0, 0, PANGO_PIXELS(prect.width) + 5,
		       PANGO_PIXELS(prect.height));
