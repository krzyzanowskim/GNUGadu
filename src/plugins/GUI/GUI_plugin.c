/* $Id: GUI_plugin.c,v 1.46 2004/01/17 00:44:59 shaster Exp $ */
#ifdef HAVE_CONFIG_H
#  include <config.h>
#endif
...
void gui_build_default_toolbar()
{
    ...
    gtk_toolbar_insert_stock(GTK_TOOLBAR(main_toolbar), GTK_STOCK_PREFERENCES, _("Open preferences window"), NULL, (GtkSignalFunc) gui_preferences,
			     NULL, 0);
    gtk_toolbar_insert_stock(GTK_TOOLBAR(main_toolbar), GTK_STOCK_QUIT, _("Exit program"), NULL, (GtkSignalFunc) gui_quit, NULL, 0);

    gtk_toolbar_append_element(GTK_TOOLBAR(main_toolbar), GTK_TOOLBAR_CHILD_BUTTON, NULL, NULL, _("Show/hide inactive users"), NULL,
			       create_image("show-hide-inactive.png"), (GtkSignalFunc) show_hide_inactive, NULL);
}
