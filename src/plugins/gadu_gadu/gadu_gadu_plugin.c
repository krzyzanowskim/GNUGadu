/* $Id: gadu_gadu_plugin.c,v 1.3 2003/03/23 11:51:32 zapal Exp $ */
...
void start_plugin()
{
	...
	/* proba rejestracji menu specyficznego dla tego plugina w GUI */
...
//
//	    	connect_count = 0;
//		if (sp && sp->status != GG_STATUS_NOT_AVAIL_DESCR) {
//		    print_debug("KUUUUUUUUUUUUUUURWAAA MAAAAAAC\n");    
//		    gadu_gadu_login(NULL);
//		}
//
//	    } else if (connected && sp) {
